...
const AppTable: React.FC<TableProps> = ({ data, columns, dropdownOptions }) => {
        ...
        <tr key={idx}>
          ...
          <td className="px-5 py-3 border-b border-gray-200 bg-white text-sm text-right">
            <div className="relative inline-block text-left" ref={el => dropdownRefs.current[idx] = el}>
              ...
              {dropdownOpen[idx] && (
                <div className="cursor-pointer z-10 min-w-40 origin-top-right absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none " role="menu" aria-orientation="vertical">
